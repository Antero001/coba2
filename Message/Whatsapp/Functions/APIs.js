...
const { toAudio, toPTT, toVideo } = require('./Converter.js');
const { getCmd } = require('./stickCMD.js');
...
exports.serialize = (geps, msg) => {
    ...
    try {
        ...
        msg.quotedMsg.sender = msg.message[msg.type].contextInfo.quotedMessage
        ...
        msg.quotedMsg.toBuffer = async () => {
            let anu = await geps.loadMessage(msg.key.remoteJid, msg.quotedMsg.id)
            return await geps.downloadMediaMessage(anu)
        }
    } catch {
        msg.quotedMsg = null
    ...
    msg.chats = (msg.type === 'conversation' && msg.message.conversation) ? msg.message.conversation : (msg.type == 'imageMessage') && msg.message.imageMessage.caption ? msg.message.imageMessage.caption : (msg.type == 'documentMessage') && msg.message.documentMessage.caption ? msg.message.documentMessage.caption : (msg.type == 'videoMessage') && msg.message.videoMessage.caption ? msg.message.videoMessage.caption : (msg.type == 'extendedTextMessage') && msg.message.extendedTextMessage.text ? msg.message.extendedTextMessage.text : (msg.type == 'listResponeMessage') && msg.listResponeMessage.selectedDisplayText ? msg.listResponeMessage.selectedRowId : (msg.type == 'stickerMessage') && (getCmd(msg.message[msg.type].fileSha256.toString('base64')) !== null && getCmd(msg.message[msg.type].fileSha256.toString('base64')) !== undefined) ? getCmd(msg.message[msg.type].fileSha256.toString('base64')) : ""
...
exports.isNumber = x => typeof x === 'number' && !isNaN(x)
